...
export type SemanticDefinitionType = 'SEMANTIC_RELATIONSHIP' 
      | 'SEMANTIC_DIMENSION' 
      | 'SEMANTIC_MEASUREMENT';

export type SemanticDimensionDataType = 'TEXT' 
      | 'DATE';
...
export type SemanticMeasurementDataType = 'NUMERIC' 
      | 'DURATION';

export type SemanticRelationshipJoinType = 'LEFT' 
      | 'INNER';
...
export type FlowAssignmentOperator = 'Assign' 
      | 'Add' 
      | 'Subtract' 
      | 'AddItem' 
      | 'RemoveFirst' 
...
export type UserAccessPolicyFilterTargetType = 'PermissionSet' 
      | 'PermissionSetGroup' 
      | 'PermissionSetLicense' 
      | 'Profile' 
      | 'UserRole' 
